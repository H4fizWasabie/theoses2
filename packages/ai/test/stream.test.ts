...
describe("Generate E2E Tests", () => {
	...
	describe.skipIf(!hasCloudflareAiGatewayCredentials())("Cloudflare AI Gateway → OpenAI (GPT-5.5 via /openai)", () => {
		const llm = getModel("cloudflare-ai-gateway", "gpt-5.5");
	...
	// =========================================================================
	// OAuth-based providers (credentials from ~/.theoses/agent/oauth.json)
	...
	if (!process.env.THEOSES_NO_LOCAL_LLM) {
		try {
