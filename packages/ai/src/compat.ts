/**
 * Compatibility entrypoint for the legacy API surface
 ...
 *
 * Existing apps switch imports from "theoses-ai" to
 * "theoses-ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/theoses-messages.lazy.ts";
...
import { theosesMessagesApi } from "./api/theoses-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "theoses-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "theoses-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "theoses-ai/providers/all" or `Models.getProviders()`. */
