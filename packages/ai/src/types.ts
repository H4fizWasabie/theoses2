...
import type { TheosesMessagesOptions } from "./api/theoses-messages.ts";
...
export interface AssistantMessage {
	...
	responseProvider?: string; // Upstream provider that actually served the call (OpenRouter's `chunk.provider`, e.g. "Baidu" vs the "DeepInfra" fallback)
