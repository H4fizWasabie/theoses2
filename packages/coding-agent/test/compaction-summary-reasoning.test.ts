...
import type { AssistantMessage, Context, Model } from "theoses-ai";
...
vi.mock("theoses-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("theoses-ai/compat")>();
	return {
		...actual,
