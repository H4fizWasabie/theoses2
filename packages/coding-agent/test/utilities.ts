...
import type { OAuthCredentials } from "theoses-ai";
import { getModel, streamSimple } from "theoses-ai/compat";
import { builtinProviders } from "theoses-ai/providers/all";
...
// ============================================================================
// OAuth API key resolution from ~/.theoses/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".theoses", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.theoses/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.theoses/agent/auth.json
 */
...
export const THEOSES_AGENT_DIR = join(homedir(), ".theoses", "agent");

/**
 * Get an AuthStorage instance backed by ~/.theoses/agent/auth.json
