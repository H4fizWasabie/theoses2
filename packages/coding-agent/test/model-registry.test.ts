...
import type { AnthropicMessagesCompat, Api, Context, Model, OpenAICompletionsCompat } from "theoses-ai/compat";
import { getApiProvider, getSupportedThinkingLevels } from "theoses-ai/compat";
