...
const originalSkipVersionCheck = process.env.THEOSES_SKIP_VERSION_CHECK;
...
afterEach(() => {
	...
	if (originalSkipVersionCheck === undefined) {
		delete process.env.THEOSES_SKIP_VERSION_CHECK;
	} else {
		process.env.THEOSES_SKIP_VERSION_CHECK = originalSkipVersionCheck;
	}
});
