...
Play DOOM as an overlay in theoses. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
theoses --extension ./examples/extensions/doom-overlay
```
...
- [theoses-doom](https://github.com/badlogic/theoses-doom) for the original theoses integration
