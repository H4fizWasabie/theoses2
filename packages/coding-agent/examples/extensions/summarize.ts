import { uuidv7 } from "theoses-ai";
import type { ExtensionAPI, ExtensionCommandContext } from "theoses-coding-agent";
import { DynamicBorder, getMarkdownTheme } from "theoses-coding-agent";
import { Container, Markdown, matchesKey, Text } from "theoses-tui";
...
export default function (theoses: ExtensionAPI) {
	theoses.registerCommand("summarize", {
