...
Example extensions for theoses-coding-agent.

## Usage

```bash
# Load an extension with --extension flag
theoses --extension examples/extensions/permission-gate.ts

# Or copy to extensions directory for auto-discovery
cp permission-gate.ts ~/.theoses/agent/extensions/
```
...
| `event-bus.ts` | Inter-extension communication via `theoses.events` |
