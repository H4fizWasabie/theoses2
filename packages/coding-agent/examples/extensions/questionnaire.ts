...
import { Editor, type EditorTheme, Key, matchesKey, Text, visibleWidth, wrapTextWithAnsi } from "theoses-tui";
...
export default function questionnaire(theoses: ExtensionAPI) {
