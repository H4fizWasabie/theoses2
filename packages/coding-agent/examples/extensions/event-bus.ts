 ...
 *
 * Shows theoses.events for communication between extensions. One extension
...
export default function (theoses: ExtensionAPI) {
	...
	theoses.events.on("my:notification", (data) => {
