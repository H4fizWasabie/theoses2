...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "theoses-coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "theoses-tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "theoses-tui";
...
export default function (theoses: ExtensionAPI) {
	...
	theoses.registerCommand("overlay-animation", {
	...
	theoses.registerCommand("overlay-anchors", {
	...
	theoses.registerCommand("overlay-margins", {
	...
	theoses.registerCommand("overlay-stack", {
	...
	theoses.registerCommand("overlay-overflow", {
	...
	theoses.registerCommand("overlay-edge", {
	...
	theoses.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	theoses.registerCommand("overlay-maxheight", {
	...
	theoses.registerCommand("overlay-sidepanel", {
	...
	theoses.registerCommand("overlay-toggle", {
	...
	theoses.registerCommand("overlay-passive", {
	...
	theoses.registerCommand("overlay-focus", {
	...
	theoses.registerCommand("overlay-streaming", {
