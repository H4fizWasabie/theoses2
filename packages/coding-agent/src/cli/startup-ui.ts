...
import { ProcessTerminal, setKeybindings, type TUI, TuiMainScreen } from "theoses-tui";
...
const OFFICIAL_PACKAGE_NAME = "theoses-coding-agent";
const OFFICIAL_APP_NAME = "theoses";
const OFFICIAL_CONFIG_DIR_NAME = ".theoses";
 ...
 * - this is the official Theoses distribution (not a fork/rebrand)
 * - experimental features are enabled (THEOSES_EXPERIMENTAL=1)
