...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `theoses-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "theoses-coding-agent";
	 *
...
/** Configuration for registering a provider via theoses.registerProvider(). */
...
export type ExtensionFactory = (theoses: ExtensionAPI) => void | Promise<void>;
