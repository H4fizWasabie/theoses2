...
For non-Windows cross-builds, or for custom Windows toolchains, set `THEOSES_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
THEOSES_TUI_WIN32_TOOLCHAIN=mingw \
