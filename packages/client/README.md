...
The `theoses-client` root remains transport- and runtime-neutral. Importing the Node-compatible transport requires the explicit `theoses-client/unix` subpath.
