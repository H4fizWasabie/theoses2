import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "theoses-ai";
import { encodeServerMessage, PROTOCOL_VERSION } from "theoses-protocol";
