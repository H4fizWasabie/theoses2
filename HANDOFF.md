...
- **`pi-self-learning` source**: `~/.pi/agent/npm/node_modules/pi-self-learning` (README + `extensions/self-learning.ts`, 2560 lines) — read for the promotion-boundary ticket, now a settled non-factor for Theoses2's design.
