...
function generateShrinkwrap() {
	...
	const { packages: shrinkwrapPackages, internalNames } = createDependencyGraph({
		lockPackages,
		repoRoot,
		rootPackageJson: codingAgentPackage,
		rootEntry: copyPackageJsonEntry(codingAgentPackage, { includeName: true }),
	});
