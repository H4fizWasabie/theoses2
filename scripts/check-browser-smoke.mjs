...
const outputPath = join(tmpdir(), "theoses-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "theoses-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "theoses-browser-smoke-errors.log");
